...
print('abbreviation of "California" state:',usa_states_info['states'][4]['abbreviation'])
print('Alabama state 3rd area code:',usa_states_info['states'][-5]['area_codes'][-3])
print('state name:',usa_states_info['states'][2]['name'])
