...
"""
l3 = [1, 2, 3]
print(l3[1])#indexing gets the value of single value in this it is int type
print(l3[1::3])#slicing gets the value of more than one type as collections in these it is of list type
